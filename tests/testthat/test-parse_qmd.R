test_that("parse_qmd creates correct objects", {
  ...
  expect_length(out[[4]][[3]]$get_children(), 3)
...
test_that("parse_qmd creates correct line numbers", {
  ...
  expect_equal(out[[2]]$get_end(), 6)

  expect_equal(out[[3]]$get_start(), 7)
  expect_equal(out[[3]]$get_end(), 10)

  expect_equal(out[[4]]$get_start(), 11)
  expect_equal(out[[4]]$get_end(), 24)

  expect_equal(out[[3]][[1]]$get_start(), 7)
  expect_equal(out[[3]][[1]]$get_end(), 7)
  expect_equal(out[[3]][[2]]$get_start(), 8)
  expect_equal(out[[3]][[2]]$get_end(), 10)

  expect_equal(out[[4]][[1]]$get_start(), 11)
  expect_equal(out[[4]][[1]]$get_end(), 11)

  expect_equal(out[[4]][[2]]$get_start(), 12)
  ...
  expect_equal(out[[4]][[3]][[2]]$get_end(), 19)

  expect_equal(out[[4]][[3]][[3]]$get_start(), 20)
  expect_equal(out[[4]][[3]][[3]]$get_end(), 24)
